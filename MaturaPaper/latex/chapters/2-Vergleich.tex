...
\begin{enumerate}
\item
Der QHScompiler ist der von mir nach meinem Aufbau entwickelte Compiler. Seine genaue Funktionsweise wird in Abschnitt \ref{cha:4-QHS_Compiler} ausgeführt.
...
\begin{table}[H]
    ...
    \begin{tabular}{l|l}
    Ausgabe als Assembly-Code       & Die Ausgabesprache muss Assembly sein                                    \\
