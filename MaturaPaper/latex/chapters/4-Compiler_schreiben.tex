...
\begin{table}[h]
    ...
    %                                       &                                                                   \\
    %\textless{}identifierChar\textgreater{} & = {[}\textasciicircum{}\# "\textless{}whitespace\textgreater{}{]} \\
...
%Die \textit{Order} gelangt zur \textit{Execute-Phase}, wenn die \textit{Order} \textit{orderQueue-proof} oder die \textit{OrderQueue} deaktiviert ist.
