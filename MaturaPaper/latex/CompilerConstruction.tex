...
Betreut durch \\
Thomas Jampen}
\publishers{\includegraphics{resources/logo}\vspace{1cm}\\
...
\input{chapters/1-was_ist_ein_Compiler.tex}
\input{chapters/2-meine_Idee.tex}
\input{chapters/3-definition_of_requirements.tex}
