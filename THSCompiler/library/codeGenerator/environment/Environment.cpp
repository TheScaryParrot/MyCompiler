...
class Environment
{
   public:
    ...
    bool HasVariable(std::string identifier) { return variables.HasElement(identifier); }
    /// @brief Returns true if the given variable is in the current environment
    bool HasVariable(Variable* variable) { return variables.HasElement(variable); }
    ...
    bool HasFunction(std::string identifier) { return functions.HasElement(identifier); }
    /// @brief Returns true if the given function is in the current environment
    bool HasFunction(Function* function) { return functions.HasElement(function); }
    ...
    bool HasType(std::string identifier) { return typeEnvironments.HasElement(identifier); }
    /// @brief Returns true if the given type is in the current environment
    bool HasType(Type* type)
    {
        return typeEnvironments.FindElement(
                   [type](std::shared_ptr<EnvironmentElement<TypeEnvironment>> typeEnvironment) -> bool
                   { return typeEnvironment->GetElement()->first.get() == type; }) != nullptr;
    }
    ...
    JumpLabel* GetLabel(std::string identifier) { return jumpLabels.GetElement(identifier).get(); }
    /// @brief Returns true if the given label is in the current environment
    bool HasLabel(std::string identifier) { return jumpLabels.HasElement(identifier); }
...
std::shared_ptr<Variable> Environment::GetVariable(std::string identifier) { return variables.GetElement(identifier); }
...
std::shared_ptr<Function> Environment::GetFunction(std::string identifier) { return functions.GetElement(identifier); }
...
Type* Environment::GetType(std::string identifier) { return GetType(GetTypeEnvironment(identifier)); }
...
Type* Environment::GetType(std::shared_ptr<TypeEnvironment> typeEnvironment) { return typeEnvironment->first.get(); }
