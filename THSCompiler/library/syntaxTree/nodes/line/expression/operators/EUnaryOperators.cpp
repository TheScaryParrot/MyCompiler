...
std::string EPreUnaryOperatorsToString(EPreUnaryOperators unaryOperator)
{
    ...
    {
        case EPreUnaryOperators::PRE_NONE: return "";
        case EPreUnaryOperators::PRE_NEGATE: return "-";
        case EPreUnaryOperators::PRE_NOT: return "!";
        case EPreUnaryOperators::PRE_INCREMENT: return "++";
        case EPreUnaryOperators::PRE_DECREMENT: return "--";
    }
...
std::string EPostUnaryOperatorsToString(EPostUnaryOperators unaryOperator)
{
    switch(unaryOperator)
    {
        case EPostUnaryOperators::POST_NONE: return "";
        case EPostUnaryOperators::POST_INCREMENT: return "++";
        case EPostUnaryOperators::POST_DECREMENT: return "--";
    }
