...
{
   public:
    UnaryExpressionNode(EPreUnaryOperators preUnaryOperator, AbstractExpressionNode* value,
...
UnaryExpressionNode::UnaryExpressionNode(EPreUnaryOperators preUnaryOperator, AbstractExpressionNode* value,
                                         EPostUnaryOperators postUnaryOperator)
...
UnaryExpressionNode::~UnaryExpressionNode() { delete value; }
